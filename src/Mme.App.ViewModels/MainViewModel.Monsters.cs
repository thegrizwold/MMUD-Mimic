...
public sealed partial class MainViewModel
{
    ...
    /// <summary>NMR version of the open database (Info table), 0 when none.</summary>
    public double NmrVersion => _nmrVer;

    /// <summary>2.3.4: the Monsters grid gets a "BS Defense" column only
    /// with a database created by NMR v1.83+ (the column doesn't exist
    /// before that).</summary>
    public bool HasBsDefenseColumn => _nmrVer >= 1.83;
