...
public sealed class SpellCastValues
{
    ...
    /// <summary>2.3.4: tabSpells("ReqLevel") — spell immunity is compared
    /// against the spell's required level, not the level it was cast at.</summary>
    public short RequiredLevel { get; set; }                  // nRequiredLevel (Integer)
}