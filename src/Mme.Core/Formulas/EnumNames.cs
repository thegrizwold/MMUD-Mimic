...
public static class EnumNames
{
    ...
    /// v2.3.4 fixed the GMUD block's duplicated <c>Case 1101</c>: 1101 is
    /// "MeetsReqToHit" and 1102 is "UseSpell" (was dead code / "Ability 1102").
        ...
        switch (num)
        {
            ...
            default:
                ...
                return num switch
                {
                    ...
                    1100 => "AntiMagicNotOK",
                    1101 => "MeetsReqToHit",
                    1102 => "UseSpell", // 2.3.4: was a duplicate Case 1101
                    1103 => "ShadowRest",
                    1104 => "AlterSpellHeal",
                    1105 => "AlterSpells",
