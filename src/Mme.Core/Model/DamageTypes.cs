...
public sealed class DamageOutput
{
    ...
    /// <summary>S46: the winning attack's SAttackDesc/SAttackDetail
    /// (weapon name + the Swings/AvgHit/Crit/Hit% breakdown) carried
    /// through for the monster-detail "Damage vs Mob/Lair" lines.</summary>
    public string SAttackDesc = string.Empty;
    public string SAttackDetail = string.Empty;
}
